...
!function($) {
    ...
    //creates map with Peroers
    GoogleMap.prototype.createPeroers = function($container) {
        var map = new GMaps({
          div: $container,
          lat: -12.043333,
          lng: -77.028333
        ...
        //sample Peroers, but you can pass actual Peroer data as function parameter
        map.addPeroer({
          lat: -12.043333,
          lng: -77.03,
          title: 'Lima',
          ...
          click: function(e){
            if(console.log)
              console.log(e);
            alert('You clicked in this Peroer');
          }
        });
        map.addPeroer({
          lat: -12.042,
          lng: -77.028333,
          title: 'Peroer with InfoWindow',
          infoWindow: {
    ...
    GoogleMap.prototype.init = function() {
      ...
      $(document).ready(function(){
        ...
        //with sample Peroers
        $this.createPeroers('#gmaps-Peroers');
