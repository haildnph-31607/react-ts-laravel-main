    ...
    <div class="slider-area">
        <div class="swiper-container slider__active">
            <div class="slider-wrapper swiper-wrapper">
                ...
                <div class="single-slider swiper-slide slider-height d-flex align-items-center" data-background="{{asset('uploads/banner/'.$item->image)}}">
                    <div class="container">
                        <div class="row">
                            <div class="col-xl-5">
                                <div class="slider-content">
                                    <div class="slider-top-btn" data-animation="fadeInLeft" data-delay="1.5s">
                                        <a href="{{route('detail-product',$item->link)}}" class="st-btn b-radius"></a>
                                    </div>
                                    <h2 data-animation="fadeInLeft" data-delay="1.7s" class="pt-15 slider-title pb-5">{{ $item->title }}</h2>
                                    <p class="pr-20 slider_text text-white" data-animation="fadeInLeft" data-delay="1.9s">{!! $item->content !!}</p>
                                    <div class="slider-bottom-btn mt-75">
                                        <a data-animation="fadeInUp" data-delay="1.15s" href="{{route('detail-product',$item->link)}}" class="st-btn-b b-radius">Xem Ngay</a>
                                    </div>
                                </div>
                            </div>
                        </div>
